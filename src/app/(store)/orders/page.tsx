  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4'>
        <div className='bg-white p-4 sm:p-8 rounded-xl shadow-lg w-full max-w-4xl'>
            <h1 className='text-4xl font-bold text-gray-800 tracking-tight mb-8'>My Orders</h1>
            {orders.length === 0 ? (
                            ...
                            className='bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden'>
                                <div className="p-4 sm:p-6 border-b border-gray-200">
                                    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center mb-4">
                                        <div>
                                            <p className='text-sm mb-1 text-gray-600 font-bold'>order number</p>
                                ...
                                <div className="flex flex-col gap-4 ms:flex-row sm:justify-between sm:items-center">
                                ...
                                {order.amountDiscount ? (
                                    <div className="mt-4 p-3 sm:p-4 bg-red-50 rounded-lg">
                                        <p className='text-red-600 font-medium mb-1 text-sm sm:text-base'>Discount Appliend: {"  "}
                                            {formatCurrency((order.totalPrice ?? 0) + order.amountDiscount, order.currency)}
                                        </p>
                                    </div>
                                ) : null}
                                <div className='px-4 py-3 ms:px-6 sm:py-4'>
                                        ...
                                        {order.products?.map((product)=>(
                                            ...
                                            <div className='flex items-center gap-3 sm:gap-4'>
                                                {product.product?.image && (
                                                    <div className="relative h-14 w-14 sm:h-16 sm:14 flex-shrink-0 rounded-md overflow-hidden">
                                                        <Image
