...
// Query: *[ _type == "product" && slug.current == $slug] | order(name asc)[0]{        _id,        name,         price,         description,        image,         slug,         stock,    }
...
// Variable: GET_PRODUCT_BY_CATEGORY_QUERY
// Query: *[ _type == "product" && references( *[ _type == "category" && slug.current == $categorySlug]._id)] | order(name asc)
export type GET_PRODUCT_BY_CATEGORY_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: PRODUCT_SEARCH_BY_NAME_QUERY
// Query: *[ _type == "product" && name match $searchParam] | order(name asc)
export type PRODUCT_SEARCH_BY_NAME_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: ACTIVE_COUPON_CODE_QUERY
// Query: *[ _type == "sales" && isActive == true && counponCode == $couponCode ] | order(validForm desc)[0]
export type ACTIVE_COUPON_CODE_QUERYResult = {
  _id: string;
  _type: "sales";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[ _type == \"product\" && references( *[ _type == \"category\" && slug.current == $categorySlug]._id)] | order(name asc)": GET_PRODUCT_BY_CATEGORY_QUERYResult;
    "\n            *[ _type == \"product\" && name match $searchParam] | order(name asc)\n        ": PRODUCT_SEARCH_BY_NAME_QUERYResult;
    "\n            *[ _type == \"sales\" && isActive == true && counponCode == $couponCode ] | order(validForm desc)[0]\n        ": ACTIVE_COUPON_CODE_QUERYResult;
  }
}
